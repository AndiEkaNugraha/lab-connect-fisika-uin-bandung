    ...
    <form class="info-box" method="POST" enctype="multipart/form-data">
      ...
      <div class="col-12 m-t-3">
        <fieldset class="form-group">
          ...
          <input type="file" name="banner" id="input-file-max-fs" class="dropify" data-max-file-size="2M" data-default-file=<?= isset($lab->lab_banner)? '/assets/file/lab/'.$lab->lab_banner:'/assets/img/banner-lab-default.jpg' ?> />
      ...
      <div class="d-md-flex">
        <div class="col-md-6 m-t-2">
          <fieldset class="form-group">
            ...
            <input name="stock" value="<?= $stock?? $lab->seo_lab??'' ?>" class="form-control" type="number" placeholder="0">
          </fieldset>
        </div>
        <div class="col-md-6 m-t-2">
          <fieldset class="form-group">
            <label>Number of damaged equipment</label>
            <input name="damaged" value="<?= $damaged?? $lab->seo_lab??'' ?>" class="form-control" type="number" placeholder="0">
          </fieldset>
        </div>
      </div>
      <div class="col-12 m-t-2">
